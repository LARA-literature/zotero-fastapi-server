...
"""Console script for zotero_fastapi_server."""
...
def parse_command_line():
    ...
    description = "zotero_fastapi_server"
...
def main():
    ...
    print("Replace this message by putting your code into zotero_fastapi_server.__main__")
